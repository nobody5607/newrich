                ...
                <div className={classes.marginTop}>
                    <Grid container>
                        <Grid item xs={12} className={classes.gridHeader}>
                            <Grid container style={{background:'#f7f6f6',borderRadius:'10px',padding:'10px'}}>
                                <Grid item md={3} xs={3} style={{marginLeft:'-3px',paddingTop:'10px'}}>
                                ...
                                <Grid item md={9} xs={9} className={classes.font12} style={{color:'rgb(0, 121, 145)'}}>
                                    <div className="profile-header">
                                        สวัสดิ์ดี,{profileResult && profileResult.profile.name}</div>
                                    <div className="profile-header">
                                            ...
                                            <Grid item xs={12} style={{marginTop:'-10px'}}>
                                                <Grid container >
                                                    ...
                                                    <Grid item md={6} xs={6} style={{textAlign:'left'}}>
                                                       <small>เงินคืนสะสมทั้งหมด</small>
                                                        <div style={{color:'#000',fontSize:'16pt'}}><i>฿ {(profileResult && profileResult.order && profileResult.order.totalPrice) ? profileResult.order.totalPrice : '0'}</i></div>
                                                    </Grid>
                                                </Grid>
                                            </Grid>
                    ...
                    <ul className="nav nav-pills nav-justified home-menu" tabIndex='1'>
                            <li className="nav-item">
                                <a onClick={this.inCome} className="nav-link " href="#" tabIndex='1'>
                                    ...
                                    <div className='text-head'>รายรับรวม</div>
                                </a>
                            </li>
                            <li className="nav-item">
                                <a className="nav-link " target="_blank" href={itoplusUrl} tabIndex={-1} aria-disabled="true">
                                    ...
                                    <div className='text-head'>สั่งสินค้า</div>
                                </a>
                            </li>
                            <li className="nav-item">
                                <a className="nav-link " target="_blank" href={itoplusUrl} tabIndex={-1} aria-disabled="true">
                                    ...
                                    <div className='text-head'>ขอคืนเงิน</div>
                                </a>
                            </li>
                    </ul>
                </div>
